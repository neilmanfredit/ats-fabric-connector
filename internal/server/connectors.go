...
func GetConnectors() []ConnectorType {
	...
	connectors = append(
		...
		genericURIConnector("bullhorn", "Bullhorn", []string{"bullhorn"}, true, false),
		...
		genericURIConnector("exchangeratesapi", "Exchangerates API", []string{"exchangeratesapi"}, true, false),
		...
		genericURIConnector("okta", "Okta", []string{"okta"}, true, false),
		...
		genericURIConnector("payrails", "Payrails", []string{"payrails"}, true, false),
